...
errorList_lasso, lasso_wisize, lasso_prd = multi_proccess_LASSO(windowList = np.arange(60,65,1), paramList = np.arange(0.001,0.002,0.001), regress = True)
...
[excel_writer(storepath,('prd_'+i),lasso_prd[i])for i in fxspot.drop('Date',axis =1).columns.tolist()]
